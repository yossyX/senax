...
use db::misc::Updater as _;
use db::models::@{ group_name|to_var_name }@::@{ mod_name|to_var_name }@::*;
// #[allow(unused_imports)]
...
use crate::repositories::@{ group_name|to_var_name }@::@{ mod_name|to_var_name }@::_@{ pascal_name }@Joiner;
use crate::repositories::ModelTr as _;

type _Getter_ = dyn db::models::@{ group_name|to_var_name }@::_base::_@{ mod_name }@::_@{ pascal_name }@Getter;
