...
use super::constants::UNACCONTABLE_WORDS;
use regex::Regex;
...
///
/// ```
///     use senax_inflector::singularize::to_singular;
...
#[test]
fn singularize_others() {
    assert_eq!("person", to_singular("people"));
    assert_eq!("person", to_singular("person"));
    assert_eq!("mouse", to_singular("mice"));
    assert_eq!("mouse", to_singular("mouse"));
}
